...
SIZES = [
    ...
    ("se-land-667", 667, 375, 2, True),
    ("phone-land-844", 844, 390, 3, True),
    ("promax-land-932", 932, 430, 3, True),
    ...
    ("desk-1280x620", 1280, 620, 1, False),
    ("desk-1366x600", 1366, 600, 1, False),
    ("desk-1180x600", 1180, 600, 1, False),
